...
<%
  ...
  <br><br>
	...
	<div class="container"><!--Form to update only required data-->
	
	<h2><center>Update inquiry</center></h2><br>
        <br><br>
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="agent" name="agent" value="<%= agent %>">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="solution" name="solution" value="<%= solution %>">
    </div>
  </div>
  <br>
  <div class="row">
    <input type="submit" name = "submit" value="Update inquiry"><!-- Update button -->
  </div>
  </form>
</div>
<!-- Footer site of site -->
